...
def generate_launch_description():
    ...
    config_file = os.path.join(yaml_dir, 'whitesandscouting.yaml')
    print(config_file)
    ...
    fake_path_params = config.get('fake_path_publisher', {}).get('ros__parameters', {})
    ...
    return LaunchDescription([ 
        ...
        Node(
            package='foxglove_visualization',  # Replace with the package where Foxglove is defined
            executable='gps_visualizer',  # Replace with the executable name of Foxglove
            name='gps_visualizer',
            output='screen',
            parameters=[visualizer_params]
        ...
        Node(
            package='foxglove_visualization',  # Replace with your actual package name
            executable='fake_path_publisher',  # Replace with the executable name
            name='fake_path_publisher',
            output='screen',
            parameters=[fake_path_params]
        ),
