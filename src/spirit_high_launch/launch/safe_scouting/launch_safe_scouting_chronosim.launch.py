...
def generate_launch_description():
    ...
    chrono_sim_process = ExecuteProcess(
        cmd=['/home/shipengl/ros2_ws/src/trusses_chrono_sim/bin/rhex_soil_stiffness_path_planning_ros2'],
        output='screen'
    )

    delayed_chrono_sim_start = TimerAction(
        period=3.0,
        actions=[chrono_sim_process]
    )
